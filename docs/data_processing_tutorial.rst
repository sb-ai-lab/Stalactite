...
When experiment runs from "local_experiment.py" file, you can use "load_parameters" function:


.. autofunction:: examples.utils.local_experiment.get_random_ingredients.load_parameters
