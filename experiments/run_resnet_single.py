...
from stalactite.party_single_impl import PartySingleResNet, PartySingleResNetSplitNN
...
def run(config_path: Optional[str] = None):
    ...
    if divided:
        party = PartySingleResNetSplitNN(
...
if __name__ == "__main__":
    run(config_path="configs/resnet-sbol-single.yml")
