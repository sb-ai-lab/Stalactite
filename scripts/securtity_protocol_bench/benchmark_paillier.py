...
@click.option("--encoding-precision", type=float, required=False, help="Encoding precision.", default=1e-15)
@click.option("--precision", type=float, required=False, help="Encoding precision.", default=1e-15)
@click.option("--round", type=int, required=False, help="Round mantissa.", default=15)
def main(mlflow_addr: str, experiment: str, key_n_length: int, encoding_precision: float, precision: float, round: int):
    # 'node3.bdcl:5555'
    ...
    for n_threads in threads:
        ...
        for array_size in ARR_SIZES:
            with mlflow.start_run():
                ...
                print('Generating arrays', array_size, precision)
